...
void run_cycles(Vripple_adder_prim* tb, VerilatedVcdC* vcd, vluint64_t& main_time, int cycles) {
...
int main(int argc, char **argv) {
    ...
    Vripple_adder_prim *tb = new Vripple_adder_prim;
